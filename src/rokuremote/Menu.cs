...
public class Menu
{
    ...
    {    
        ...
        {
            case 1:        
                var apps = await Client.ListDeviceApps(selectedDevice.Endpoint);
                ...
                break;
            case 2:
                var currentApp = await Client.GetCurrentApp(selectedDevice.Endpoint);
    ...
    public static async Task RequestAppSelection(string endpoint, IEnumerable<App> apps )
    {
    ...
    while (!apps.Any(a => a.Id == appId) )
    {
        ...
        Console.WriteLine("Please enter a valid app Id");
    ...
    if(appId != "q")
    {
        await Client.LaunchApp(endpoint, appId);
    }
